...
GameStore.Categories = {
 {
   ...
   name = "Consumables",
   rookgaard = true,
   subclasses = {"Casks", "Exercise Weapons", "Kegs", "Potions", "Runes"},
 },
 -- Casks
 {
